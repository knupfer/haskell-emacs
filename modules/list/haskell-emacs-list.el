;;; haskell-emacs-list.el --- Haskell functions from Data.List
...
;; URL: https://github.com/knupfer/haskell-emacs/modules/list

;;; Commentary:

;; haskell-emacs-list.el provides nearly all haskell functions from
;; Data.List.  It uses `haskell-emacs' to register these functions.
...
(provide 'haskell-emacs-list)

;;; haskell-emacs-list.el ends here
