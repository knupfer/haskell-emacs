;;; haskell-emacs-bits.el --- Haskell functions from Data.Bits
...
;; Data.Bits.  It uses `haskell-emacs' to register these functions.
...
(provide 'haskell-emacs-bits)

;;; haskell-emacs-bits.el ends here
